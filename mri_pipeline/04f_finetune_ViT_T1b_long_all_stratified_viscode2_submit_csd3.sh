...
#SBATCH --job-name=vit_T1b
#SBATCH --output=logs/vit_T1b_%A_%a.log
#SBATCH --error=logs/vit_T1b_%A_%a.err
#SBATCH -p ampere
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
#SBATCH --array=0-5
# =============================================================================
# 04f_finetune_ViT_T1b_long_all_stratified_viscode2_submit_csd3.sh
# =============================================================================
# Fine-tunes ViT_B_mae75 on T1b (binary CN+MCI vs AD) using ALL longitudinal
# sessions (--long all) with:
#
...
#
# T1b maps CN->0, MCI->0, AD->1 (complement of T1 which maps CN->0, MCI+AD->1)
#
# 1 task x 3 seeds x 2 strategies = 6 combinations.
# Array index decoder:
#   STRAT_IDX -> SEED_IDX (low-to-high stride)
#
# Usage:
#   sbatch mri_pipeline/04f_finetune_ViT_T1b_long_all_stratified_viscode2_submit_csd3.sh
#   sbatch --array=0 mri_pipeline/04f_finetune_ViT_T1b_long_all_stratified_viscode2_submit_csd3.sh
# =============================================================================
...
# Output dir (same root as 04e; T1b task gets its own subdirectory)
...
# -- Combination lookup: T1b only, 3 seeds, 2 strategies ----------------------
TASK="T1b_binary"
SEEDS=(0 1 2)
...
echo "============================================================"
echo "  ViT fine-tuning — T1b (CN+MCI vs AD), VISCODE2 strat, --long all"
