...
#SBATCH --job-name=bmvp_head_T1e
#SBATCH --output=/home/ec474/rds/hpc-work/ADNI_MRI/brainmvp_debug/slurm_logs/bmvp_head_T1e_%A_%a.log
#SBATCH --error=/home/ec474/rds/hpc-work/ADNI_MRI/brainmvp_debug/slurm_logs/bmvp_head_T1e_%A_%a.err
#SBATCH -p icelake
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --array=0-53%4
# =============================================================================
# 04_brainmvp_head_sweep_T1e_submit_csd3.sh
# =============================================================================
# Cached-embedding head HP sweep on the NEW T1e_pcn_vs_scn task. T1e is the
# pCN-vs-sCN binary task (212 subjects = 60 pCN + 152 sCN, balanced 1:2.5).
# Same head architecture + HP grid as the prior cached-head sweep, just
...
#
# Submit:  sbatch mri_pipeline/cached_head_sweep/04_brainmvp_head_sweep_T1e_submit_csd3.sh
# Resume:  resubmit -- per-cell metrics.json check makes it idempotent.
# =============================================================================
...
MODEL_NAME="BrainMVP"
EMBED_DIM=512
WANDB_PROJECT="${WANDB_PROJECT:-brainmvp_frozen_cached_T1e}"
export WANDB_MODE="${WANDB_MODE:-offline}"

# T1e-only sweep grid: 1 x 3 x 3 x 3 x 2 = 54
TASK="T1e_pcn_vs_scn"
SEEDS=(0 1 2)
