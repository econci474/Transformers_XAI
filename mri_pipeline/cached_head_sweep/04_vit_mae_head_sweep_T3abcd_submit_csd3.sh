...
#SBATCH --job-name=vit_head_T3abcd
#SBATCH --output=/home/ec474/rds/hpc-work/ADNI_MRI/vit_outputs_debug/slurm_logs/vit_head_T3abcd_%A_%a.log
#SBATCH --error=/home/ec474/rds/hpc-work/ADNI_MRI/vit_outputs_debug/slurm_logs/vit_head_T3abcd_%A_%a.err
#SBATCH -p icelake
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# =============================================================================
# 04_vit_mae_head_sweep_T3abcd_submit_csd3.sh
# =============================================================================
# Cached-head HP sweep on T3a/b/c/d using ViT-MAE 768-d frozen embeddings
# (from cached_embeddings/vit_mae/vit_mae_pooled.pt). Same grid as the
# BrainMVP/BrainDINO T3abcd sweeps -- only model_name + embed_dim + paths
# differ.
#
# 4 tasks x 3 seeds x 3 LRs x 3 drops x 2 LSs = 216 cells.
#
# Submit:  sbatch mri_pipeline/cached_head_sweep/04_vit_mae_head_sweep_T3abcd_submit_csd3.sh
# =============================================================================
...
echo "============================================================"
echo "  ${MODEL_NAME} cached-head sweep -- T3a/b/c/d"
