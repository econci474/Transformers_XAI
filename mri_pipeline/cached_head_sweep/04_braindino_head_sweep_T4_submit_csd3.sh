...
#SBATCH --job-name=bdino_head_T4
#SBATCH --output=/home/ec474/rds/hpc-work/ADNI_MRI/braindino_outputs/slurm_logs/bdino_head_T4_%A_%a.log
#SBATCH --error=/home/ec474/rds/hpc-work/ADNI_MRI/braindino_outputs/slurm_logs/bdino_head_T4_%A_%a.err
#SBATCH -p icelake
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --array=0-53%4
# =============================================================================
# 04_braindino_head_sweep_T4_submit_csd3.sh
# =============================================================================
# Cached-embedding head HP sweep on T4_conv_horizon (3-class ordinal:
# <3y / 3-7y / >=7y conversion bucket for pMCI + pCN_to_AD = 146 subjects).
# Mirrors the BrainMVP T4 sweep with BrainDINO 768-d frozen embeddings.
#
# 1 task x 3 seeds x 3 LRs x 3 drops x 2 LSs = 54 cells.
#
# Submit:  sbatch mri_pipeline/cached_head_sweep/04_braindino_head_sweep_T4_submit_csd3.sh
# =============================================================================
...
EMBED_DIM=768
WANDB_PROJECT="${WANDB_PROJECT:-braindino_frozen_cached_T4}"
