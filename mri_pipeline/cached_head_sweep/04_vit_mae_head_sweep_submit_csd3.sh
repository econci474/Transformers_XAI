...
#SBATCH --job-name=vitmae_head
#SBATCH --output=/home/ec474/rds/hpc-work/ADNI_MRI/vit_outputs_debug/slurm_logs/vitmae_head_%A_%a.log
#SBATCH --error=/home/ec474/rds/hpc-work/ADNI_MRI/vit_outputs_debug/slurm_logs/vitmae_head_%A_%a.err
#SBATCH -p icelake
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# =============================================================================
# 04_vit_mae_head_sweep_submit_csd3.sh  --  cached-embedding head HP sweep
# =============================================================================
# Trains the 2-layer MLP head on ViT-MAE75 cached CLS embeddings (768-d).
# Same HP grid as BrainDINO + BrainMVP sweeps.
#
...
if [ ! -f "${EMBEDDINGS_PT}" ]; then
    ...
    echo "        Run vit_mae/03d_extract_vit_mae_embeddings.py first."; exit 1
fi
