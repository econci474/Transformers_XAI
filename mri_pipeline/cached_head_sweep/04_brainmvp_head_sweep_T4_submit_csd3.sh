...
#SBATCH --job-name=bmvp_head_T4
#SBATCH --output=/home/ec474/rds/hpc-work/ADNI_MRI/brainmvp_debug/slurm_logs/bmvp_head_T4_%A_%a.log
#SBATCH --error=/home/ec474/rds/hpc-work/ADNI_MRI/brainmvp_debug/slurm_logs/bmvp_head_T4_%A_%a.err
#SBATCH -p icelake
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --array=0-53%4
# =============================================================================
# 04_brainmvp_head_sweep_T4_submit_csd3.sh
# =============================================================================
...
#   --matched_labels_csv has the Label_T4 column (added in-place by 01e).
#
# Submit:  sbatch mri_pipeline/cached_head_sweep/04_brainmvp_head_sweep_T4_submit_csd3.sh
# =============================================================================
...
MODEL_NAME="BrainMVP"
EMBED_DIM=512
WANDB_PROJECT="${WANDB_PROJECT:-brainmvp_frozen_cached_T4}"
